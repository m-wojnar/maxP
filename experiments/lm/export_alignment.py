...
SUFFIXES = ("wq", "wk", "wv", "wqkv", "wo", "w1", "w2", "w3", "fc1", "fc2",
            "in_proj", "out_proj", "x_proj", "dt_proj", "q_proj", "k_proj",
            "v_proj", "o_proj", "i_proj", "f_proj", "up_proj", "down_proj",
            "output")
...
def _suffix(layer: str) -> str | None:
    if layer == "output":
        return "output"
    m = re.search(r"(wq|wk|wv|wqkv|wo|w1|w2|w3|fc1|fc2|in_proj|out_proj|"
                  r"x_proj|dt_proj|q_proj|k_proj|v_proj|o_proj|i_proj|f_proj|"
                  r"up_proj|down_proj)$", layer)
