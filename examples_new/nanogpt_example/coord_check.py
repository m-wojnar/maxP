...
Usage:
    python examples_new/nanogpt_example/coord_check.py --plot                 # vanilla
    python examples_new/nanogpt_example/coord_check.py --parametrized --plot  # muP
"""
...
from examples_new.nanogpt_example.gpt import GPT
from examples_new.nanogpt_example.parametrized_gpt import (
