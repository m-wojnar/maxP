...
Usage:
    python examples_new/transformer.py          # train on synthetic seq2seq, print loss
"""
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        # TODO: remove — temporary fix to verify coord check catches it
...
def train(model, steps=200, seq_len=64, batch_size=32, lr=3e-4):
    ...
    for step in range(steps):
        # Repeat pattern: generate short pattern, tile it → next-token is predictable
        pattern_len = 4
