...
Usage:
    python examples/dag_solver_demo.py              # print tables
    python examples/dag_solver_demo.py --plot       # also save figure
    python examples/dag_solver_demo.py --plot -o my_fig.png
"""
