...
Usage:
    python examples/vit_example/train.py
    python examples/vit_example/train.py --widths 64 128 256
    python examples/vit_example/train.py --steps 1000 --n-lrs 7
    python examples/vit_example/train.py --no-plot
"""
