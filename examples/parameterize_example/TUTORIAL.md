...
```bash
python examples/parameterize_example/run.py --plot
```
...
```bash
python examples/visualize_dag.py --solve
python examples/visualize_dag.py --solve --n-layers 1  # simpler view
```
...
```bash
python examples/parameterize_example/run.py --parametrized --plot
```
