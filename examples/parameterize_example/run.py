...
Usage:
    python examples/parameterize_example/run.py --plot                 # vanilla
    python examples/parameterize_example/run.py --parametrized --plot  # muP
"""
...
from examples.parameterize_example.transformer import Transformer
